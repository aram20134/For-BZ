    ...
    <div class="head-content">
        ...
        <?php 
        	if(isset($_SESSION['logged_user'])) {
                ...
                <div class="drop-profmenu not-drop">
                    <div class="razdel" style="border-top:none;">Профиль</div>
                    <a href="profile" class="link">'.$_SESSION['logged_user']->number.$a.$_SESSION['logged_user']->name.'</a>
        ...
        <div class="menu">
            ...
            <div class="drop-headmenu not-drop">
                <div style="display:none;border-top:none;"  class="razdel" id="m3" >Phase 1</div>
                ...
                <div class="razdel" style="border-top:none;" id="m9">Прочее</div>
